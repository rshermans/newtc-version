...
export const RadarChart = ({ userScores, aiScores }: RadarChartProps) => {
...
export const ComparisonBars = ({ userScore, aiScore }: ComparisonBarsProps) => {
...
interface FactualityThermometerProps {
    score: number;
}
// Componente para visualização interativa de termômetro de factualidade
export const FactualityThermometer = ({ score }: FactualityThermometerProps) => {
  // Determinar a categoria de factualidade com base no score
  const getFactualityCategory = (score: number) => {
...
interface InteractiveScoreComparisonProps{
